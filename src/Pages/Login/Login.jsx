                    ...
                    <form onSubmit={handleSubmit(onSubmit)} >
                        <div className='mt-4'>
                            ...
                            {...register("email", { required: true })}
                                className='block text-black w-full px-4 py-2 bg-slate-400 border rounded-lg    focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300'
                                type='email'
                            /> <br />
                        ...
                        <div className='mt-4'>
                            ...
                            <input 
                                ...
                                className='block w-full px-4 py-2 text-gray-700 border rounded-lg bg-slate-400 focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300'
                                type='password'
                            />
                             {errors.password && <small className="text-red-500">Password field is required.</small>}
                        </div>
                        <div className='mt-6'> 
                        <input type="submit"  className='w-full btn-outline border-0 border-b-2 btn-primary px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50' value="Sign In" /> 
                        </div>
                    </form>
